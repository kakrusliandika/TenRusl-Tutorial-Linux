# 📦 Dasar Server keluarga RHEL

## Ringkasan
Sistem keluarga RHEL mendukung siklus hidup paket bergaya perusahaan, operasi yang mendukung SELinux, dan jaringan yang digerakkan oleh NetworkManager.

## Apa Arti Konsepnya
Dasar server keluarga RHEL adalah kumpulan paket, layanan, keputusan jaringan, identitas, dan aturan penyimpanan minimal yang dapat dijelaskan yang Anda terapkan sebelum perangkat lunak khusus beban kerja hadir.
