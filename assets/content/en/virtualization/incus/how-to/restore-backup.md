...
## Objective
Restore a backup or export into a safe target on Incus and prove the recovered workload is operational, not just present.
...
```bash
incus export app01 /srv/incus-backups/app01.tar.gz
incus delete app01 --force
incus import /srv/incus-backups/app01.tar.gz
```
