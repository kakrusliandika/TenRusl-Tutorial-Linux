# 🌐 CloudPanel
    ...
    ## Overview
    This module treats CloudPanel as a Linux hosting control plane, not as magic. The focus is host preparation, site onboarding, runtime verification, admin-surface control, backup scope, and shell-based recovery when the panel or generated config does not behave as expected. CloudPanel is a hosting control plane oriented toward modern cloud VPS workflows. It usually leans on Nginx, PHP-FPM, and database-backed site management.

    ## Who This Section Is For
    - Operators running websites or app stacks on Debian- or Ubuntu-based VPS hosts who want a faster hosting workflow without losing shell validation.
    ...
    ## Learning Path
    1. Start with [🧠 CloudPanel Overview](./concepts/cloudpanel-overview.md) and the concept pages so the control-plane boundaries are clear.
...
4. Walk the tutorial series on a lab host before trusting the panel with real domains or customer data.
    ...
    ## What To Read First
    - Concept: [🧠 CloudPanel Overview](./concepts/cloudpanel-overview.md)
    ...
    ## Section Map
### Concepts
- [🧠 CloudPanel Overview](./concepts/cloudpanel-overview.md)
