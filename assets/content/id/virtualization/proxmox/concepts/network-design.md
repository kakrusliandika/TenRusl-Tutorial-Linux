...
bridge link
bridge vlan show
grep -n "vmbr" /etc/network/interfaces 2>/dev/null || true
```

## File Terkait Dalam Modul Ini
- [🧠 Ikhtisar Proxmox](./proxmox-overview.md)
