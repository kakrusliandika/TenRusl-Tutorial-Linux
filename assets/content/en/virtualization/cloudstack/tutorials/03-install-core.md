...
## Objective
Bring the core CloudStack control plane into a known-good state before networks, storage, and guest artifacts are expanded.
...
CloudStack install details vary by release and distribution. Use the supported packages or bootstrap method for your release, then validate management services, host visibility, storage pools, and template handling before you onboard real workloads.
