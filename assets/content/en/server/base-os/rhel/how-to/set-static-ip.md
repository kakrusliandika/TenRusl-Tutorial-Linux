# 🌐 Set a Static IP
        ...
        ## Objective
        Make network identity on RHEL-family predictable enough that SSH, DNS, reverse proxy routing, and monitoring do not depend on changing DHCP leases.
        ...
        - RHEL-family systems usually use NetworkManager and nmcli for persistent network changes. Keep firewalld and SELinux context in view while adjusting connectivity.
