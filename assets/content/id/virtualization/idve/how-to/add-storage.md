...
## Tujuan
Menambahkan atau mengekspos storage ke IDVE tanpa menebak fungsi, kapasitas, atau cara memvalidasinya.
...
## Prasyarat
- Anda sudah tahu apakah storage baru dipakai untuk workload aktif, image dasar dan template, backup, atau staging restore.
