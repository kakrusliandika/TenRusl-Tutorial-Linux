# 📋 Service Checklist
    ...
    ## Purpose
    Use this checklist before handing a RHEL-family host to another team member or before layering workload-specific software on top.
...
| Remote access | SSH is enabled and validated | systemctl status sshd --no-pager; ss -ltnp | grep :22 || true |
...
```
    ...
    - On RHEL-family systems, hardening means understanding sshd, firewalld, and SELinux together from day one.
