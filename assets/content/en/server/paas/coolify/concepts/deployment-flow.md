...
## Summary
Deployment flow is the path from Git or image source to running service, including build logic, secrets, storage, domain routing, and post-deploy validation.
