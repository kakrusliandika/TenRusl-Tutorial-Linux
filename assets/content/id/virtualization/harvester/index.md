...
## Ringkasan
Harvester memadukan virtualisasi dengan operasi cluster bergaya Kubernetes, sehingga node health, storage class, network attachment, dan VM lifecycle harus dibaca sebagai satu sistem. Modul ini memusatkan perhatian pada kebiasaan operasi cluster yang tetap bisa diverifikasi dari Linux dan Kubernetes tooling.

## Siapa yang Cocok Menggunakan Bagian Ini
- Operator yang mengelola VM pada stack HCI atau cluster-oriented virtualization.
- Admin yang butuh disiplin node, storage, backup, dan restore di lingkungan multi-host.
- Pembelajar yang ingin mengaitkan VM operations dengan health cluster dan storage classes.
...
2. Gunakan halaman cara untuk menambah storage, merapikan jaringan, mengelola image VM dan template, dan melatih restore.
...
- Konsep: [🧠 Ikhtisar Harvester](./concepts/harvester-overview.md)
...
- [📦 Kelola Image VM dan Template](./how-to/manage-templates.md)
