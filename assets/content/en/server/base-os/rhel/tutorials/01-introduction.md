# 🧭 Tutorial 01: Introduction
        ...
        ## Objective
        Define why this host exists, what RHEL-family brings to the job, and what the baseline must guarantee before applications are installed.
        ...
        - RHEL-family is a strong choice where supportability, dnf workflows, SELinux, and enterprise alignment matter more than the smallest possible image.
