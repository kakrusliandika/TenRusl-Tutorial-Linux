...
## Tujuan
Menambahkan atau mengekspos storage ke Proxmox tanpa menebak fungsi, kapasitas, atau cara memvalidasinya.
...
## Prasyarat
- Anda sudah tahu apakah storage baru dipakai untuk workload aktif, template dan image dasar, backup, atau staging restore.
...
df -h
findmnt -t nfs,nfs4,cifs,ceph 2>/dev/null || true
```
