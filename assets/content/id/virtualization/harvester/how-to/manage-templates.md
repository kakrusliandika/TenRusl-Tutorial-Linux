# 📦 Kelola Image VM dan Template

## Tujuan
Menjaga image VM dan template tetap terkendali, terdokumentasi, dan tervalidasi sebelum dijadikan sumber workload baru.

## Kapan Prosedur Ini Digunakan
Gunakan saat Anda mengimpor, menerbitkan, memperbarui, atau menonaktifkan image VM dan template.
...
```bash
kubectl api-resources | grep -Ei "image|template" || true
