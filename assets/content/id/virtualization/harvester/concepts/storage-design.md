...
## Apa Arti Konsep Ini
Desain storage berarti memutuskan di mana workload aktif berjalan, di mana image VM dan template disimpan, di mana backup ditempatkan, dan bagaimana restore dilakukan tanpa menimpa data yang salah. Tujuannya bukan sekadar menambah kapasitas, tetapi menambah kapasitas dengan peran yang jelas.
...
- [🧠 Ikhtisar Harvester](./harvester-overview.md)
