# 📋 Service Checklist
    ...
    ## Purpose
    Use this checklist before handing a Debian host to another team member or before layering workload-specific software on top.
...
```
    ...
    - Debian hardening should keep SSH visible, the firewall intentional, and the package set small enough to audit.
