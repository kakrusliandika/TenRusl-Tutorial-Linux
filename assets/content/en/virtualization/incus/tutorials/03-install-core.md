...
## Objective
Bring the core Incus control plane into a known-good state before networks, storage, and guest artifacts are expanded.
...
On supported distributions, install Incus and initialize it with `incus admin init`, then validate networking, storage, and image handling before you create real workloads.
