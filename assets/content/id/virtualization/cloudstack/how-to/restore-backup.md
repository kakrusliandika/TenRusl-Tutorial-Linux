...
## Tujuan
Melatih restore pada CloudStack secara sengaja sehingga backup bukan hanya arsip, tetapi benar-benar jalur recovery.
...
command -v cloudmonkey >/dev/null && cloudmonkey list virtualmachines || true
journalctl -u cloudstack-management -n 80 --no-pager 2>/dev/null || true
```
