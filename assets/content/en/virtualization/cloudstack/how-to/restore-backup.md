...
## Objective
Restore a backup or export into a safe target on CloudStack and prove the recovered workload is operational, not just present.
...
sudo mysql cloud < /srv/backups/cloudstack/cloud-YYYYMMDD.sql
