...
In the aaPanel model, the panel coordinates web-server config, site roots, runtime bindings, and administrative tasks. The operator still owns host patching, firewall policy, service review, backup scope, and incident response.
...
## Related Docs
- [🧠 aaPanel Overview](./aapanel-overview.md)
