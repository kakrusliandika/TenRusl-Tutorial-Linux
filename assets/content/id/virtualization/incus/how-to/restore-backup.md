...
## Tujuan
Melatih restore pada Incus secara sengaja sehingga backup bukan hanya arsip, tetapi benar-benar jalur recovery.
...
incus import /var/backups/incus/app01-backup.tar.gz 2>/dev/null || true
incus list
```
