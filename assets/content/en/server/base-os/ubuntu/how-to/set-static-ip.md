# 🌐 Set a Static IP
        ...
        ## Objective
        Make network identity on Ubuntu predictable enough that SSH, DNS, reverse proxy routing, and monitoring do not depend on changing DHCP leases.
        ...
        - Ubuntu Server usually uses netplan, but cloud-init may still own the source of truth. Confirm which layer writes the final config before making static changes.
