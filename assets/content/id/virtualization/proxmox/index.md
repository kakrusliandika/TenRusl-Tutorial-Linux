...
## Ringkasan
Proxmox memadukan KVM, LXC, storage, cluster, dan bridge Linux dalam satu control plane yang tetap harus dipahami dari sisi host. Modul ini menjadikan Proxmox sebagai platform operasi yang bisa diuji, bukan sekadar dashboard untuk membuat VM.

## Siapa yang Cocok Menggunakan Bagian Ini
- Operator yang mengelola KVM dan LXC pada host berbasis Debian atau cluster Proxmox.
- Admin lab atau platform internal yang membutuhkan alur guest, template, backup, dan restore yang bisa diulang.
- Pembelajar yang ingin memahami bagaimana node, storage, jaringan, dan backup saling berkaitan secara nyata.
...
- Konsep: [🧠 Ikhtisar Proxmox](./concepts/proxmox-overview.md)
...
## Peta Bagian
### Konsep
- [🧠 Ikhtisar Proxmox](./concepts/proxmox-overview.md)
