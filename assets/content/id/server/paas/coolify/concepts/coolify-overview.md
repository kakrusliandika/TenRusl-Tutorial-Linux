...
## Ringkasan
Coolify paling baik diperlakukan sebagai bidang kontrol aplikasi yang di-host sendiri yang berlapis di atas Linux dan Docker, bukan sebagai pengganti untuk memahami container, penyimpanan, DNS, dan status proxy terbalik.
