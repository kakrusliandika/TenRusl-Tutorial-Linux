...
## Tujuan
Menambahkan atau mengekspos storage ke Harvester tanpa menebak fungsi, kapasitas, atau cara memvalidasinya.
...
## Prasyarat
- Anda sudah tahu apakah storage baru dipakai untuk workload aktif, image VM dan template, backup, atau staging restore.
